...
public class Activity4 {
    ...
    public void contactsTest() {
        ...
        driver.findElement(AppiumBy.xpath(
                "//android.widget.EditText[@text='First name']")).sendKeys("Aj");
        driver.findElement(AppiumBy.xpath(
                "//android.widget.EditText[@text='Last name']")).sendKeys("reddy");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Phone']")).sendKeys("9956281645");
        ...
        Assert.assertEquals(contactName, "Aj reddy");
    }
