...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("1677978783");
        // Press ENTER
        ...
        // Enter text to send
        driver.findElement(AppiumBy.id("compose_message_text")).sendKeys("Hello! from Appium APP");
        // Press Send
