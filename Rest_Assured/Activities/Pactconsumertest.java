package fst_rest_assured_project;
	...
	// Create Map for the headers
		...
		public RequestResponsePact createPact(PactDslWithProvider builder) throws ParseException { 
			...
			DslPart bodySentCreateUser = new PactDslJsonBody()
					.numberType("id", 1)
					.stringType("firstName", "rest")
					.stringType("lastName", "testing")
					.stringType("email", "restactivity@mail.com");
		...
		public void runTest() {
			...
			map.put("id", 1);
			map.put("firstName", "rest");
			map.put("lastName", "testing");
			map.put("email", "restactivity@mail.com");
